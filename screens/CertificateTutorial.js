...
const data = [
  {
    image: require('../assets/cert/cert1.png'),
    key: '1',
  },
  {
    image: require('../assets/cert/cert2.png'),
    key: '2',
  },
  {
    image: require('../assets/cert/cert3.png'),
    key: '3',
  },
];

export default function CertificateTutorial({ navigation }) {

  React.useLayoutEffect(() => {
    navigation.setOptions({
      headerTitle: () => (
        <View>
          <Text style={{ color: '#FFF', alignSelf: 'center', fontSize: 20, fontWeight: 'bold' }}>How to use</Text>
        </View>
      )
    });
  }, [navigation]);
      ...
      <View style={{ backgroundColor: '#000', width: '100%', height: height - width - 100, alignItems: 'center', paddingTop: 8 }}>
        {!bannerError && <BannerAd
          ...
          unitId={__DEV__ ? TestIds.BANNER : Platform.select({
            ios: TestIds.BANNER,
            android: 'ca-app-pub-1354543839348242/1267386228',
          })}
